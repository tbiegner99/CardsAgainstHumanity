...
import { CardSlider, Card } from '../../src/components/CardSlider';
import { BlackCard } from '../../src/components/CardsAgainstHumanityCard';

import style from './CardSlider.css';

const stories = storiesOf('CardSlider', module);
stories.addDecorator(withKnobs);
stories.add('displays correctly', () => (
  <CardSlider cardClass={style.cardClass} cardsPerFrame={number('cardsPerFrame', 1)}>
    <Card>
